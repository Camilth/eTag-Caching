...
De eTag logica bevindt zich in ProductController.java. Je hebt een RequestHeader nodig voor het endpoint, waarin je de eTag die de browser meegeeft bemachtigd.